...
const CYCLES = [
  {
    ...
    description: "Shared component library (DONE — 8/8 components built & adopted incl. DatePicker) + API layer + global error handling. Remaining: API error handling.",
  ...
  },
  {
    ...
    description: "Build missing admin screens, bulk operations, referral panel, PDF/Excel exports, and polish. Progress: Bulk add (done), announcement preview (done), soft delete (done), trend+tooltip (done), date range filter (done), Excel export (done), PDF export (done). Remaining: event detail, add recording, referral panel, warning wire, send warning.",
...
const TASKS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: "FE-M0-01", title: "Scaffold auth page layout and route", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Screen"], desc: "AuthPage wrapper, centered card container, BGG logo/brand header. DONE: Auth layout with split-panel, centered card, BGG logo, brand header." },
  { id: "FE-M0-02", title: "Build Sign In with Google button", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Component"], desc: "GoogleOAuthButton component, OAuth redirect handler, loading spinner state. DONE: Google OAuth via Clerk SSO with GoogleIcon SVG." },
  { id: "FE-M0-03", title: "Build email + password sign-in form", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Component"], desc: "EmailInput, PasswordInput (toggle visibility), Sign In submit button, form error message. DONE: Full Clerk sign-in with error handling." },
  { id: "FE-M0-04", title: "Build email + password sign-up form", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Component"], desc: "EmailInput, PasswordInput + confirm, password strength indicator, Sign Up submit button. DONE: Full Clerk sign-up with email verification." },
  { id: "FE-M0-05", title: "Implement form validation (signup)", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Logic"], desc: "Inline errors: duplicate email, weak password, invalid format. DONE: HTML required attrs, terms checkbox, Clerk server validation, AuthContext helpers." },
  { id: "FE-M0-06", title: "Build Forgot Password flow", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Screen"], desc: "'Forgot password?' link, email input page, confirmation message. DONE: Clerk resetPasswordEmailCode with success confirmation." },
  { id: "FE-M0-07", title: "Handle auth routing logic", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 1", "Auth", "Logic"], desc: "Redirect new users → onboarding, returning → dashboard. DONE: RouteGuard with role-based routing + Clerk middleware." },
  { id: "FE-M0-08", title: "Style auth page — responsive layout", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 1", "Auth", "Style"], desc: "Mobile-first layout, Tailwind card shadow/spacing, accessible focus states. DONE: Responsive split-panel with mobile-hidden brand panel." },

  { id: "FE-M1-01", title: "Scaffold multi-step onboarding shell", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "Screen"], desc: "OnboardingLayout wrapper, step progress indicator, Next/Back buttons. DONE: 5-step shell with progress bar, step nav, sticky footer." },
  { id: "FE-M1-02", title: "Onboarding Step 1 — Basic info form", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Step1BasicInfo with displayName, occupation, industry select, location, bio with char count." },
  { id: "FE-M1-03", title: "Onboarding Step 2 — Profile photo upload", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Step2Photo with drag-drop, file input, preview, 2MB limit, remove button, photoFileRef." },
  { id: "FE-M1-04", title: "Onboarding Step 3 — Social links input", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Step3Socials with website, linkedin, twitter, github inputs with icons and placeholders." },
  { id: "FE-M1-05", title: "Onboarding Step 4 — Privacy toggles", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Step4Privacy with profileVisible, showEmail, showSocials, showLocation boolean toggles." },
  { id: "FE-M1-06", title: "Onboarding Step 5 — Optional Dev Plan setup", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Step5DevPlan with devGoalTitle and milestones, saves to localStorage on finish." },
  { id: "FE-M1-07", title: "Implement onboarding state persistence", status: "Done", priority: "High", cycle: null, labels: ["Sprint 1", "Onboarding", "State"], desc: "DONE: localStorage persistence via STORAGE_KEY, loadOnboarding/saveOnboarding, auto-save on data change." },
  { id: "FE-M1-08", title: "'Complete Dev Plan' prompt if skipped", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 1", "Onboarding", "Component"], desc: "DONE: Dashboard showDevPlanBanner with dismissable banner linking to /member/devplan." },
  ...
  { id: "FE-M2-05", title: "Implement auth route guards", status: "Done", priority: "Urgent", cycle: null, labels: ["Sprint 2", "App Shell", "Logic"], desc: "DONE: RouteGuard in AuthContext + Clerk middleware protecting all non-public routes, role-based routing." },
  ...
  { id: "FE-M3-03", title: "Implement RSVP toggle logic", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 2", "Dashboard", "Logic"], desc: "DONE: useRsvpEvent() hook calls POST /events/:id/rsvp via API, fully wired." },
  ...
  { id: "FE-M3-07", title: "Wire dashboard data fetching", status: "Done", priority: "High", cycle: null, labels: ["Sprint 2", "Dashboard", "State"], desc: "DONE: Dashboard uses useEvents() and useJobs() hooks with real API via useAuthSWR." },
  ...
  { id: "FE-C3-07", title: "Implement cohort feed access control", status: "Done", priority: "High", cycle: null, labels: ["Sprint 3", "Cohorts", "Logic"], desc: "Hide feed/block compose for non-members. Guard route by cohort membership check. DONE: Membership check using useCohortMembers + useUser. Non-members see 'Members Only' lock screen." },
  { id: "FE-C3-08", title: "Wire cohort data fetching", status: "Done", priority: "High", cycle: null, labels: ["Sprint 3", "Cohorts", "State"], desc: "DONE: useCohorts/useCohort/useCohortMembers/useCohortSessions/useCohortResources all wired to API via useAuthSWR." },
  ...
  { id: "FE-R4-02", title: "Implement YouTube thumbnail extraction", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 4", "Recordings", "Logic"], desc: "Need: parse YouTube URL → video ID, construct thumbnail URL, fallback placeholder. Currently hardcoded. DONE: extractYouTubeId + getYouTubeThumbnail utilities in lib/utils.ts." },
  { id: "FE-R4-03", title: "Build Recordings page / full list view", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 4", "Recordings", "Screen"], desc: "DONE: Full recordings page with grid+list views, search, type filter, recording count." },
  { id: "FE-R4-04", title: "Style recording grid — responsive", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 4", "Recordings", "Style"], desc: "DONE: Responsive grid (1/2/3 cols), list view toggle, fully styled." },
  ...
  { id: "FE-J5-04", title: "Implement Seek Referral action + dedup", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 5", "Jobs", "Logic"], desc: "DONE: useRequestReferral() calling POST /jobs/:id/referral-request with dedup, toast on success/error." },
  { id: "FE-J5-05", title: "Build Jobs search + filter", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 5", "Jobs", "Component"], desc: "DONE: Real-time search filtering by title, company, location via useMemo." },
  { id: "FE-J5-06", title: "Wire jobs data fetching", status: "Done", priority: "High", cycle: null, labels: ["Sprint 5", "Jobs", "State"], desc: "DONE: useJobs() calling GET /jobs, useRequestReferral() calling POST via useAuthSWR." },
  ...
  { id: "FE-D6-05", title: "Implement delete flow (soft delete)", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 6", "Community", "Logic"], desc: "DONE: handleDeletePost() calling DELETE /community/posts/:id with auth token, [deleted] display." },
  { id: "FE-D6-06", title: "Wire community feed data + pagination", status: "Done", priority: "High", cycle: null, labels: ["Sprint 6", "Community", "State"], desc: "DONE: useCommunityGroups/useChannelPosts with cursor-based pagination via useAuthSWR." },
  ...
  { id: "FE-MD6-04", title: "Implement visibility rules (frontend)", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 6", "Members", "Logic"], desc: "Some toggle exists but profileVisible/socialsVisible not enforced from real user data. DONE: filteredMembers now filters out members where profile.isPublic === false." },
  { id: "FE-MD6-05", title: "Build member search (real-time)", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 6", "Members", "Logic"], desc: "DONE: Real-time search by name, role, location via searchTerm + filteredMembers useMemo." },
  ...
  { id: "FE-DP7-05", title: "Implement mark-complete logic", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 7", "Dev Plan", "Logic"], desc: "DONE: cycleStatus() cycling not-started→in-progress→completed, persists to localStorage." },
  { id: "FE-DP7-06", title: "Build 'All done' prompt", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 7", "Dev Plan", "Component"], desc: "CompletionBanner: 'You've completed your plan!' CTAs: 'Set a new plan' | 'Add more milestones'. DONE: Green gradient banner with CheckCircle, 'Set New Plan' button, startNewPlan handler." },
  { id: "FE-DP7-07", title: "Wire Action Center data to dev plan", status: "Done", priority: "High", cycle: null, labels: ["Sprint 7", "Dev Plan", "State"], desc: "useActionCenter hook: fetch milestones due in 7 days + overdue. Sort by urgency. Link items to dev plan page. DONE: Action Center reads localStorage bgg-goals, Dev Plan hero card shows live goal counts/pills." },
  ...
  { id: "FE-A8-04", title: "StatCard — add trend indicator + tooltip", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "StatCards have number + label. Need: trend indicator (up/down arrow), definition tooltip. DONE: AdminStatCard enhanced with trend (up/down/neutral) prop + tooltip with Info icon hover." },
  ...
  { id: "FE-A8-07", title: "Build Bulk Add Members modal", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "TabBar: CSV Upload | Paste Emails. CSVDropzone with validation, EmailTextarea, Process button, ResultsSummary. DONE: Full BulkAddMembersModal in admin/cohorts/[slug] with paste + CSV upload." },
  ...
  { id: "FE-A8-09", title: "Implement send warning flow", status: "In Progress", priority: "Medium", cycle: 5, labels: ["Sprint 8", "Admin", "Logic"], desc: "Warning textarea in modal. Submit updates local state only. Need: POST to notifications API." },
  ...
  { id: "FE-A8-13", title: "Add Members to Cohort — bulk support", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "Basic add-member UI exists. Need: reuse Bulk Add component (CSV + paste), ResultsSummary. DONE: BulkAddMembersModal wired to all 3 Add Members buttons in cohort detail page." },
  ...
  { id: "FE-A8-16", title: "Send Announcement form — add preview", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "Announcement textarea exists. Need: preview card, submit → post to feed + trigger notifications. DONE: AnnouncementForm has 2-column layout with live preview card." },
  ...
  { id: "FE-A8-19", title: "Build Event Detail + RSVP List view", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 8", "Admin", "Screen"], desc: "DONE: Event detail + RSVP list with search, stats using useEvent()/useEventRsvps() hooks." },
  { id: "FE-A8-20", title: "Build Add Recording link to event", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "DONE: recordingInput + saveRecording() using useAttachRecording(eventId) hook." },
  ...
  { id: "FE-A8-23", title: "Build Referral Requests panel", status: "Done", priority: "Medium", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "DONE: ReferralsPanel with useJobReferralRequests() and useUpdateReferralStatus() hooks." },
  ...
  { id: "FE-A8-25", title: "Admin delete flow — soft delete + API", status: "Done", priority: "High", cycle: null, labels: ["Sprint 8", "Admin", "Logic"], desc: "Delete button removes from local state. Need: API call, soft-delete '[deleted]' display, thread integrity. DONE: Soft delete sets content to '[deleted]', renders in italic grey, member feed detects deleted posts." },
  { id: "FE-A8-26", title: "Send Warning to member — wire to API", status: "Todo", priority: "Medium", cycle: 5, labels: ["Sprint 8", "Admin", "Logic"], desc: "No moderation API hooks exist — only mock data with local state. Need: POST → notification sent to member." },
  ...
  { id: "FE-A8-28", title: "Excel export — proper .xlsx format", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 8", "Admin", "Logic"], desc: "CSV download works from mock data. Need: trigger API export endpoint, download .xlsx via blob URL. DONE: exportXLSX utility (Open XML Spreadsheet format) in lib/export.ts, wired to analytics export dropdown." },
  { id: "FE-A8-29", title: "PDF export implementation", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 8", "Admin", "Logic"], desc: "No PDF export. Need: trigger API endpoint or print layout, download .pdf, loading state. DONE: exportPDF utility in lib/export.ts using browser print-to-PDF with branded table layout." },
  { id: "FE-A8-30", title: "Build date range filter for analytics", status: "Done", priority: "Low", cycle: null, labels: ["Sprint 8", "Admin", "Component"], desc: "Date inputs exist. Need: DateRangePicker component, apply filter → refresh engagement data. DONE: Custom DatePicker component replaces native inputs, wired with min/max constraints." },
  ...
  { id: "FE-G-08", title: "Build accessible DatePicker component", status: "Done", priority: "Low", cycle: null, labels: ["Global", "Component"], desc: "Currently native HTML date inputs. Need custom accessible DatePicker for dev plan + events. DONE: Custom popover calendar in components/ui/date-picker with month/year nav, min/max, today shortcut. Exported from barrel." },
  { id: "FE-G-09", title: "Global API error handling + 401 redirect", status: "Done", priority: "Urgent", cycle: null, labels: ["Global", "Logic"], desc: "DONE: handle401() in api.ts auto-redirects to /sign-in on 401. Wired in apiClient, SWRProvider onError, and useApiMutation catch. Smart retry skips 401/403/404." },
