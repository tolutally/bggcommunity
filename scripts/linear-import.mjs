...
const TASKS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: "FE-M0-01", title: "Scaffold auth page layout and route", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Screen"], desc: "AuthPage wrapper, centered card container, BGG logo/brand header. No auth page exists — root `/` just redirects to `/member`." },
  { id: "FE-M0-02", title: "Build Sign In with Google button", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Component"], desc: "GoogleOAuthButton component, OAuth redirect handler, loading spinner state." },
  { id: "FE-M0-03", title: "Build email + password sign-in form", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Component"], desc: "EmailInput, PasswordInput (toggle visibility), Sign In submit button, form error message." },
  { id: "FE-M0-04", title: "Build email + password sign-up form", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Component"], desc: "EmailInput, PasswordInput + confirm, password strength indicator, Sign Up submit button." },
  { id: "FE-M0-05", title: "Implement form validation (signup)", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Logic"], desc: "Inline errors: duplicate email, weak password, invalid format. useFormValidation hook." },
  { id: "FE-M0-06", title: "Build Forgot Password flow", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Screen"], desc: "'Forgot password?' link, email input page, confirmation message, link expiry error state." },
  { id: "FE-M0-07", title: "Handle auth routing logic", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 1", "Auth", "Logic"], desc: "Redirect new users → onboarding, returning → dashboard. useAuth hook + auth state guard." },
  { id: "FE-M0-08", title: "Style auth page — responsive layout", status: "Todo", priority: "Medium", cycle: 2, labels: ["Sprint 1", "Auth", "Style"], desc: "Mobile-first layout, Tailwind card shadow/spacing, accessible focus states on all inputs." },

  { id: "FE-M1-01", title: "Scaffold multi-step onboarding shell", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "Screen"], desc: "OnboardingLayout wrapper, step progress indicator, Next/Back buttons, useOnboardingStep state machine." },
  { id: "FE-M1-02", title: "Onboarding Step 1 — Basic info form", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "NameInput, OccupationInput, UniversityOrgInput, required field validation." },
  { id: "FE-M1-03", title: "Onboarding Step 2 — Profile photo upload", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "AvatarUpload (drag-and-drop + click), image preview + crop, remove/replace, fallback initials." },
  { id: "FE-M1-04", title: "Onboarding Step 3 — Social links input", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "LinkedInInput, TwitterXInput, OtherSocialInput (generic URL), add/remove row dynamically." },
  { id: "FE-M1-05", title: "Onboarding Step 4 — Privacy toggles", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "ProfileVisibleToggle (default ON), SocialsVisibleToggle (default OFF), labels, persist on submit." },
  { id: "FE-M1-06", title: "Onboarding Step 5 — Optional Dev Plan setup", status: "Todo", priority: "Medium", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "SkipButton (routes to dashboard), DevPlanMiniForm (goal + first milestone + date), Save + continue." },
  { id: "FE-M1-07", title: "Implement onboarding state persistence", status: "Todo", priority: "High", cycle: 2, labels: ["Sprint 1", "Onboarding", "State"], desc: "Save each step to API on Next, resume from last incomplete step, useOnboarding context/hook." },
  { id: "FE-M1-08", title: "'Complete Dev Plan' prompt if skipped", status: "Todo", priority: "Low", cycle: 2, labels: ["Sprint 1", "Onboarding", "Component"], desc: "ProfileBanner: 'Complete your Dev Plan' + link to dev plan page." },
  ...
  { id: "FE-M2-05", title: "Implement auth route guards", status: "Todo", priority: "Urgent", cycle: 2, labels: ["Sprint 2", "App Shell", "Logic"], desc: "ProtectedRoute HOC/wrapper, redirect unauthenticated → /auth, admin vs member route split. Currently zero auth checks." },
