...
function normalizeUserProfile(input: unknown): UserProfileRecord {
    ...
    return {
        ...
        website: readString(profile.websiteUrl) || readString(profile.website) || readString(record.website),
        linkedin: readString(profile.linkedinUrl) || readString(profile.linkedin) || readString(profile.linkedinHandle) || readString(record.linkedin),
        twitter: readString(profile.twitterUrl) || readString(profile.twitter) || readString(profile.twitterHandle) || readString(record.twitter),
