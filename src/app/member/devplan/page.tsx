        ...
        <ErrorBoundary>
            <div className="max-w-4xl mx-auto p-6 md:p-10 space-y-8">
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white rounded-3xl p-12 border border-stone-100 text-center space-y-3">
                        ...
                        <h3 className="text-lg font-bold text-stone-900">No plan yet</h3>
                        <p className="text-sm text-stone-500 max-w-xs mx-auto">Your development plan will appear here once your admin sets it up for you.</p>
                    </div>
                ) : filtered.length === 0 ? (
                    <EmptyState
                        icon={Target}
