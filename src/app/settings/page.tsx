...
import { Plus, X, Shield, Server, Plug, Activity, Lock, AlertTriangle, Save, RefreshCw, Database } from "lucide-react";
...
export default function SettingsPage() {
    ...
    return <MemberSettingsView user={user} role={role} />;
}

// --- Admin View ---

function AdminSettingsView({ user }: any) {
...
// --- Shared / Member View Implementation ---

function MemberSettingsView({ user, role }: any) {
            ...
            <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
                <div className="p-8 border-b border-stone-100 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        {role === 'mentor' && <span className="inline-block mt-1 px-2 py-0.5 bg-purple-100 text-purple-700 text-xs font-bold rounded-full uppercase tracking-wide">Mentor Account</span>}
                        <div className="mt-2">
