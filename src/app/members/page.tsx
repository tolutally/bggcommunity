...
import { Search, Filter, LayoutGrid, List as ListIcon, MoreHorizontal, Mail, Shield, Award, MapPin } from "lucide-react";
...
const MOCK_MEMBERS = NAMES.map((name, i) => ({
    ...
    role: i < 5 ? "Mentor" : "Member", // First 5 are mentors
    ...
    avatar: `https://i.pravatar.cc/150?u=${i + 10}`, // Offset to get diverse avatars
