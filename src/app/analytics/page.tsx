        ...
        <div className="p-6 md:p-10 space-y-8 max-w-7xl mx-auto animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <MetricCard
                    ...
                    change="-0.5%"
                    trend="down"
                    icon={TrendingUp} // Using TrendingUp but colored for churn
                    inverse
                />
            </div>
...
function MetricCard({ title, value, change, trend, icon: Icon, inverse }: any) {
    ...
    const isGood = inverse ? !isPositive : isPositive; // e.g., churn up is bad (red)

    return (
        <Card className="p-5 flex flex-col justify-between h-32 hover:border-purple-200 transition-colors cursor-pointer">
