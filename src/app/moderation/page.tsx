...
import { Flag, AlertTriangle, CheckCircle, XCircle, MessageSquare, User, MoreHorizontal, Clock, ShieldAlert, BadgeInfo } from "lucide-react";
...
export default function ModerationPage() {
    ...
    const handleAction = (action: string, reportId: string) => {
        ...
        // Remove from pending view for demo
            ...
            <div className="flex justify-between items-center mb-8 flex-shrink-0">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="bg-white px-4 py-2 rounded-xl border border-stone-200 shadow-sm flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-stone-500 font-bold uppercase">Avg Response</p>
                            <p className="text-xl font-bold text-stone-900">~2 hrs</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div className="max-w-3xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="border-t border-stone-100 pt-6">
                                        ...
                                        <div className="mt-4 text-center">
                                            <button
                                                onClick={() => handleAction("Ban", selectedReport.id)}
                                                className="text-stone-400 hover:text-red-600 text-xs font-bold uppercase tracking-wider transition-colors"
                                            >
                                                Ban User {selectedReport.reportedUser.name}
                                            </button>
                                        </div>
                                    </div>
                                </div>
